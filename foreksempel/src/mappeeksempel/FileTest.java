...
public class FileTest extends TestCase {
	...
	public void testContains() {
		...
		assertTrue(teaching.contains(teaching)); // Seg selv
		assertTrue(teaching.contains(folder105));
		assertFalse(teaching.contains(other)); // Den ligger som /other
	}
	...
	public void testFindAll() {
		...
		// Finne alle filer - bruker grensesnittet FilesOnly
		...
		// Finne alle foldere - bruker grensesnittet FoldersOnly
