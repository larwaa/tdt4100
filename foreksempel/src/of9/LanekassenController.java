...
public class LanekassenController {
	...
	public void save() {
		try {
			io.save("ovingsforelesning.txt", calculator, person);
		} catch (IOException e) {
	...
	public void load() {
		try {
			LanekassenObjectLoader loader = io.load("ovingsforelesning.txt");
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			output.setText("Filnavnet finnes ikke, er du sikker på at du har skrevet riktig? Sjekk en gang til");
		}
	}
