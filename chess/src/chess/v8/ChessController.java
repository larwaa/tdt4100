...
public class ChessController {
	...
	@FXML
	void initialize() {
		blackSymbols.put(PieceKind.of('R'), '♜');
		blackSymbols.put(PieceKind.of('N'), '♞');
		blackSymbols.put(PieceKind.of('B'), '♝');
		blackSymbols.put(PieceKind.of('Q'), '♛');
		blackSymbols.put(PieceKind.of('K'), '♚');
		blackSymbols.put(PieceKind.of('P'), '♟');

		whiteSymbols.put(PieceKind.of('R'), '♖');
		whiteSymbols.put(PieceKind.of('N'), '♘');
		whiteSymbols.put(PieceKind.of('B'), '♗');
		whiteSymbols.put(PieceKind.of('Q'), '♕');
		whiteSymbols.put(PieceKind.of('K'), '♔');
		whiteSymbols.put(PieceKind.of('P'), '♙');
